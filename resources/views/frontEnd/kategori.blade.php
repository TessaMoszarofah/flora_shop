            ...
            <div class="row justify-content-center">
                <div class="col-md-10 mb-5 text-center">
                    <ul class="product-category">
                        <li><a href="{{ url('/shop')}}" class="" id="product-category-all">All</a></li>
                        @foreach($kategori as $kat)
                        <li><a href="{{ route('shop.kategori', $kat->id) }}" class="{{ request()->segment(3) == $kat->id ? 'active' : '' }}" id="product-category-{{ $kat->id }}">{{ $kat->nama_kategori }}</a></li>
                        @endforeach
                    </ul>
                </div>
            </div>
