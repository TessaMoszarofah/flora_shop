        ...
        <div class="row mb-5">
            <div class="col-md">
                <div class="ftco-footer-widget mb-4">
                    <h2 class="ftco-heading-2">Flora Shop</h2>
                    <p> Kami menawarkan produk berkualitas tinggi untuk pecinta tanaman dan dekorasi hijau. Dengan layanan pengiriman yang handal, kami memastikan pengalaman belanja yang mudah dan memuaskan.</p>
                    <ul class="ftco-footer-social list-unstyled float-md-left float-lft mt-5">
                        <li class="ftco-animate"><a href="#"><span class="icon-twitter"></span></a></li>
                        <li class="ftco-animate"><a href="#"><span class="icon-facebook"></span></a></li>
                        <li class="ftco-animate"><a href="https://www.instagram.com/saa30_5/?igsh=MXFxejRjYTgybjd4OA%3D%3D"><span class="icon-instagram"></span></a></li>
                    </ul>
                </div>
            </div>
            <div class="col-md">
